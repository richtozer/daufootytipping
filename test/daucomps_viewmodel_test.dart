...
void main() {
  group('DAUCompsViewModel', () {
    ...
    test(
      'combineGameGroupsIntoRounds combines groups into rounds correctly',
      () {
        ...
        expect(
          combinedRounds.length,
          2,
          reason: 'Should combine into 2 rounds',
        );

        // First round
        expect(combinedRounds[0].dAUroundNumber, 1, reason: 'First round');
        expect(
          combinedRounds[0].firstGameKickOffUTC,
          DateTime.parse('2023-01-01T08:00:00Z'),
          reason: 'Start date',
        );
        expect(
          combinedRounds[0].lastGameKickOffUTC,
        ...
        expect(
          combinedRounds[1].firstGameKickOffUTC,
          DateTime.parse('2023-02-02T08:00:00Z'),
          reason: 'Start date',
        );
        expect(
          combinedRounds[1].lastGameKickOffUTC,
    ...
    test(
      ...
      () {
        ...
        final fixedGameGroups = _fixOverlappingLeagueGameGroups(
          sortedGameGroups,
        );
        ...
        expect(
          ...
          DateTime.parse('2023-01-02T09:00:00Z').subtract(Duration(minutes: 1)),
        );

        expect(fixedGameGroups[1]['league-round'], 'nrl-2');
        expect(
          fixedGameGroups[1]['minStartTime'],
        ...
        expect(
          fixedGameGroups[2]['minStartTime'],
          DateTime.parse('2023-01-01T09:00:00Z'),
        );
        expect(
          fixedGameGroups[2]['maxStartTime'],
          DateTime.parse('2023-01-01T11:00:00Z'),
        );
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(fixedGameGroups[0]['league-round'], 'nrl-1');
        expect(
          fixedGameGroups[0]['minStartTime'],
          DateTime.parse('2023-01-01T08:00:00Z'),
        );
        expect(
          fixedGameGroups[0]['maxStartTime'],
    ...
    test(
      ...
      () {
        ...
        expect(
          fixedGameGroups[0]['maxStartTime'],
          DateTime.parse('2023-01-01T09:00:00Z').subtract(Duration(minutes: 1)),
        );

        expect(fixedGameGroups[1]['league-round'], 'nrl-2');
        expect(
          fixedGameGroups[1]['maxStartTime'],
          DateTime.parse('2023-01-01T10:30:00Z').subtract(Duration(minutes: 1)),
        );
