  ...
  group('getFormattedHistoricalMatchups', () {
    test('Correctly formats historical games with various tip types', () async {
      ...
      when(mockTipsViewModel.findTip(
              histGame5_UserTippedDraw, mockCurrentTipper))
      ...
      expect(result[0].userTip, mockUpcomingHomeTeam.name);
      ...
      expect(result[1].userTip, isEmpty,
      ...
      expect(result[2].userTip, isEmpty);
      ...
      expect(result[3].userTip, mockUpcomingHomeTeam.name,
      ...
      expect(result[4].userTip, "Draw", reason: "User actively tipped Draw");
    });
